// Design_contextStep.cpp: implementation of the CDesign_contextStep class.
//
//////////////////////////////////////////////////////////////////////
...
CDesign_contextStep::CDesign_contextStep()
: CProduct_definition_contextStep()
{
  nameClass("DESIGN_CONTEXT");
}
...
void CDesign_contextStep::Serialize(stepArchive &ar)
{
#if 0
  try{
    if (!isSerialized()){
...
HRESULT CDesign_contextStep::backPtr(CBaseStep *&prBrep)
{
  if (NULL!=m_pBack){
